...
from dp.visualize.common import normalize_source_key

requested_files: List[Tuple[str, str]] = [
    (f"logs/{dataset}_div_{metric}_exp.jsonl", dataset) 
    for dataset in ["reddit", "tab", "db_bio"] 
    for metric in ["cosine", "bertscore"]
]
