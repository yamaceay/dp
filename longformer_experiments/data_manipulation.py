...
with open('data/TAB/splitted/train.json', "r", encoding="utf-8") as f1, open('data/TAB/splitted/dev.json', "r", encoding="utf-8") as f2, open('data/TAB/splitted/test.json', "r", encoding="utf-8") as f3:
