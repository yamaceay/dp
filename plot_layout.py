...
PRESIDIO_COLOR: str = "#8F2D56"

REFERENCE_STYLES: dict[str, tuple[str, str, int, str]] = {
    "baseline": ("Original", "D", 180, "#2ca02c"),
    "presidio": ("Presidio", "*", 220, PRESIDIO_COLOR),
    "dummy":    ("Dummy",    "X", 180, "#d62728"),
}
